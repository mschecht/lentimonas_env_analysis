...
```{bash}
# gene calls
#cat <(head -n 1 data/external/CC151_GFF3_matt.csv) <(cat data/external/CC151_GFF3_matt.csv | grep "CC151_genome_" | sed 's|CC151_genome_||')  > data/external/CC151_GFF3_matt_genome.csv
#cat <(head -n 1 data/external/CC151_GFF3_matt.csv) <(cat  data/external/CC151_GFF3_matt.csv | grep "CC151_plasmid_" | sed 's|CC151_plasmid_||')  > data/external/CC151_GFF3_matt_plasmid.csv

# fasta
#grep -n '>' data/external/CC151_full.fasta
#1:>CC151_genome
#79740:>CC151_plasmid

#wc -l data/external/CC151_full.fasta
# 97434

#> 97434 - 79740 
#[1] 17694

#head -n 79739 data/external/CC151_full.fasta > data/external/CC151_genome.fasta

#tail -n 17695 data/external/CC151_full.fasta > data/external/CC151_plasmid.fasta
```
